  ...
  return (
    <div className="mt-32 relative">
      {products.map((elem, index) => (
        <Product key={index} val={elem} mover={mover} count={index} setIsHovered={setIsHovered} />
      ))}
      <motion.div
      ...
      >
        <motion.div
          ...
          className="window absolute w-[32rem] h-[23rem] bg-white left-[45%] overflow-hidden rounded-md"
        >
