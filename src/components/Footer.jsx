    ...
    <div className="w-full h-full">
        ...
        <div className="basis-1/2 flex gap-4">
          <div className="basis-1/3">
            ...
            {["intsagram", "twitter", "LinkedIn"].map((item, index) => (
              <a key={index} className="block mt-2 text-zinc-600 capitalize">
                {item}
              </a>
            ))}
          </div>
          ...
          <div className="basis-1/2">
            ...
            <img
              className="w-[15vw] mt-10 flex justify-end"
      ...
      <div className="w-full h-full mt-2 p-5">
        {[
          ...
          <a key={index} className="ml-16 h-full text-sm text-zinc-600">
            {item}
          </a>
        ))}
      </div>
