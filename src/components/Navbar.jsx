...
const Navbar = () => {
  return (
    <div className=' max-w-screen-xl mx-auto py-6 flex items-center justify-between border-b-[1.5px] border-zinc-700'>
        <div className="left flex items-center">
            ...
            <div className="links flex gap-14 ml-20">
                {['Home', 'Work', 'Culture', '', 'News'].map((elem,index)=>(
                    elem.length ===0 ? (<span className='w-[1.5px] h-7 bg-zinc-700'></span>):(
